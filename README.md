...
- __SuGaR: Surface-Aligned Gaussian Splatting for Efficient 3D Mesh Reconstruction and High-Quality Mesh Rendering.__ _Antoine Guédon, Vincent Lepetit._ __CVPR, 2024.__ [[`Paper`](https://arxiv.org/pdf/2311.12775)] [[`Code`](https://github.com/Anttwo/SuGaR)] ([`Note`]()) (★★★☆☆)
  - By applying Singular Value Decomposition (SVD), each 3D Gaussian distribution is decomposed into three orthogonal principal components. The component corresponding to the surface normal direction is enforced to be minimized, encouraging the Gaussian to align tightly with the underlying surface geometry.
